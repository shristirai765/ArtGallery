...
<head>
    ...
    <title>Profile | Monet's Atelier</title>
...
<div class="container">
    ...
    <div class="profile-grid">
        ...
        <div class="profile-card">
            ...
            <span class="profile-role"><?php echo ucfirst($userData['role'] ?? 'User'); ?></span>
        ...
        <div class="form-card">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="bio" placeholder="Tell us about yourself..."><?php echo htmlspecialchars($userData['bio'] ?? ''); ?></textarea>
                    <span class="hint">Share a little about yourself as an art enthusiast</span>
                </div>

                <div class="form-group">
                    <label><i class="fas fa-user-tag"></i> Role</label>
                    <input type="text" value="<?php echo ucfirst($userData['role'] ?? 'User'); ?>" disabled>
